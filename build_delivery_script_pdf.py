...
body { font-family: "Liberation Serif", Georgia, serif; font-size: 10.5pt;
  line-height: 1.44; color: #14181F; margin: 0; }
h1.doc { font-family:"Liberation Sans",sans-serif; font-size:16pt; font-weight:bold;
  color:#1F3A5F; margin:0 0 3pt; line-height:1.15; }
p.sub { font-family:"Liberation Sans",sans-serif; font-size:8.5pt; color:#5C6675;
  margin:0 0 9pt; letter-spacing:.04em; text-transform:uppercase;
...
.slide { padding-top:8pt; }
.slide-head { border-bottom:1.5pt solid #1F3A5F; padding-bottom:2.5pt; margin-bottom:5pt;
  break-after:avoid; break-inside:avoid; }
.slide-head .num { font-family:"Liberation Sans",sans-serif; font-weight:bold;
  font-size:13pt; color:#1F3A5F; }
.slide-head h3 { font-family:"Liberation Sans",sans-serif; font-weight:bold; font-size:9.5pt;
  margin:1pt 0 0; line-height:1.2; }
.slide-head .time { font-family:"Liberation Sans",sans-serif; font-size:8.5pt; color:#5C6675;
  float:right; font-weight:normal; }
.slide p { margin:0 0 5pt; orphans:2; widows:2; }
.edited { background:transparent; border:none; padding:0; }
.optional { color:#6B7280; font-style:italic; }
.tag { display:none; }
.tag.opt { display:none; }
.keep { font-family:"Liberation Sans",sans-serif; font-size:7pt; font-weight:bold;
